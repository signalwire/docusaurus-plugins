...
> Docusaurus theme components for the llms-txt plugin, featuring a customizable copy page button with AI integration.

This theme package provides React components and styling for the `@signalwire/docusaurus-plugin-llms-txt` plugin, including a sophisticated copy page button that allows users to copy content or share it with AI tools like ChatGPT and Claude.
...
The main component that provides copy and AI sharing functionality. It automatically integrates with your content pages.
...
The theme uses CSS variables for comprehensive styling control. You can customize the appearance without swizzling by overriding CSS variables in your custom stylesheet.
...
This theme provides swizzlable components for advanced customization. Use Docusaurus CLI to safely customize components:
...
This package is part of the `@signalwire/docusaurus-plugins` monorepo. See the [main repository](https://github.com/signalwire/docusaurus-plugins) for contribution guidelines.
