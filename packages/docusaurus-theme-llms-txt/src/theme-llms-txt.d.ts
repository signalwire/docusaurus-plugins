...
// This file provides the package entry-point types and the ambient declarations
// TypeScript needs to understand every @theme/* component shipped by this theme.
...
declare module '@theme/CopyPageContent' {
  ...
  export type { ResolvedCopyPageContentOptions };
